...
public class VentanaRegistro extends JFrame {
    ...
    private void ajustarComponentes(Container c) {
        ...
        btnYaTengoCuenta = new JButton("Buscar Cuenta");
        btnYaTengoCuenta.setEnabled(false);
        constraints.gridx = 1;
        constraints.gridy = 2;
        constraints.insets = new Insets(5, 7, 5, 2);
        constraints.anchor = GridBagConstraints.CENTER;
//        panelFormulario.add(btnYaTengoCuenta, constraints);
    ...
    private void ajustarEventos() {
        btnRegistrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Jugador j = new Jugador("0", nom, pass); // cambiar el numero de jugador
